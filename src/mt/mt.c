...
static void CBDUMMY_config(lcb_t instance, lcb_configuration_t config) {
    (void)instance;(void)config;
}
static void CBDUMMY_error(lcb_t instance, lcb_error_t err, const char *msg) {
    (void)instance; (void)err; (void)msg;
}
...
lcbmt_init_connect(lcb_t instance)
{
    ...
    lcb_set_error_callback(instance, CBDUMMY_error);
    lcb_set_configuration_callback(instance, CBDUMMY_config);

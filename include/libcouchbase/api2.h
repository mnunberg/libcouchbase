...
/**@file
 * This file contains the older, 'legacy' API documentation */
 ...
 * @defgroup lcb-kv-legacy-api Legacy Key-Value APIs
 * @details
 *
 * This contains the documentation for the older API calls which were introduced
 * in version 2.0.0 of the client. Developers are encouraged to make use of
 * the newer API, introduced in version 2.4.0. See @ref lcb-kv-api.
 *
 * All the functions documented here are simple wrappers around the
 * new API calls; thus for example, lcb_get() is a simple wrapper around
 * lcb_get3(), and similar. Thus they documentation and such will remain
 * similar throughout, and so will their semantics.
 *
